...
public class RemovedState {
    public static void main(String[] args) {
        ...
        Customer customer = session.get(Customer.class, 1);  //Persistent State
    ...
    private static String isExistsInSession(Session session, Customer customer){
        ...
        return session.contains(customer) ? "This object is Persistence State!" : "This object is Removed State!";
    }
}
